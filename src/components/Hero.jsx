    ...
    <div className=" bg-indigo-600 ">
      ...
      <div className="relative isolate pt-14">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex flex-col lg:items-center ">
          <div className="mx-auto max-w-5xl lg:mx-0 lg:flex-auto">

            <h1 className="text-4xl leading-tight text-center font-bold tracking-tight text-white lg:text-8xl">
              Rastreando el Inventario de Hoy para el Éxito de Mañana.
            </h1>
            <p className="mt-6 text-lg leading-7 text-center  text-white lg:text-xl">
              <span className=' font-bold'>Cada artículo, cada ubicación, cada momento: </span>
