        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="flex flex-col pb-10 sm:pb-16 lg:pb-0 lg:pr-8 xl:pr-20">
            ...
            <figure className="mt-10 flex flex-auto flex-col justify-between">
              <blockquote className="text-lg leading-8 text-blue-900">
                <p>
              ...
              <figcaption className="mt-10 flex items-center gap-x-6">
                ...
                <div className="text-base">
                  <div className="font-semibold text-blue-900">Judith Black</div>
          ...
          <div className="flex flex-col border-t border-white/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
            ...
            <figure className="mt-10 flex flex-auto flex-col justify-between">
              ...
              <figcaption className="mt-10 flex items-center gap-x-6">
                ...
                />
                <div className="text-base">
                  <div className="font-semibold text-blue-900">Joseph Rodriguez</div>
